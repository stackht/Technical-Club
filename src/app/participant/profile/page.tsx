  ...
  return (
    <main className="hero-bg relative h-screen overflow-y-auto px-4 py-0 text-white/80 sm:px-6">
      ...
      <div className="relative mx-auto max-w-4xl space-y-6">
        <div className="sticky top-0 z-30 -mx-4 flex flex-col gap-3 overflow-x-hidden bg-[#050805]/95 px-4 py-3 backdrop-blur sm:-mx-6 sm:flex-row sm:items-center sm:justify-between sm:px-6">
